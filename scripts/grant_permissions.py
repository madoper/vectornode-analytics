...
cmds = [
    "docker exec podft-postgres psql -U podft -d analytics -c \"GRANT ALL ON SCHEMA analytics TO dbt_user\"",
    ...
    "docker exec podft-postgres psql -U podft -d analytics -c \"GRANT ALL ON SCHEMA staging TO dbt_user\"",
]
