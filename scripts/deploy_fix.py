...
sftp = s.open_sftp()
sftp.put(r'D:\project\FRS_TEST\dashboard\utils\data_loader.py', '/opt/analytics/dashboard/utils/data_loader.py')
sftp.put(r'D:\project\FRS_TEST\dashboard\pages\tab_groups.py', '/opt/analytics/dashboard/pages/tab_groups.py')
sftp.close()
