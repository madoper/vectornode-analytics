...
# Check tasks
stdin2, stdout2, stderr2 = ssh.exec_command('. /opt/analytics/venv/bin/activate && AIRFLOW_HOME=/opt/analytics airflow tasks states-for-dag-run vectornode_anomaly_etl manual_010 2>&1')
print('\nTasks:')
